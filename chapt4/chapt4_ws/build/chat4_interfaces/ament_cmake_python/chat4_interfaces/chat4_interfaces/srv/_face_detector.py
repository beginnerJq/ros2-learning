...
class Metaclass_FaceDetector(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'chat4_interfaces.srv.FaceDetector')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from chat4_interfaces.srv import _face_detector
...
class FaceDetector(metaclass=Metaclass_FaceDetector):
    from chat4_interfaces.srv._face_detector import FaceDetector_Request as Request
    from chat4_interfaces.srv._face_detector import FaceDetector_Response as Response
