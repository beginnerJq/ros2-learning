...
#include "chat4_interfaces/srv/detail/face_dector__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = chat4_interfaces::srv::FaceDector_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const chat4_interfaces::srv::FaceDector_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<chat4_interfaces::srv::FaceDector_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FaceDector_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const chat4_interfaces::srv::FaceDector_Request *>(
...
static size_t _FaceDector_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FaceDector_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FaceDector_Request__callbacks = {
...
static rosidl_message_type_support_t _FaceDector_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FaceDector_Request__callbacks,
...
{
  return &chat4_interfaces::srv::typesupport_fastrtps_cpp::_FaceDector_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = chat4_interfaces::srv::FaceDector_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const chat4_interfaces::srv::FaceDector_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<chat4_interfaces::srv::FaceDector_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _FaceDector_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const chat4_interfaces::srv::FaceDector_Response *>(
...
static size_t _FaceDector_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_FaceDector_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _FaceDector_Response__callbacks = {
  "chat4_interfaces::srv",
  "FaceDector_Response",
...
static rosidl_message_type_support_t _FaceDector_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FaceDector_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &chat4_interfaces::srv::typesupport_fastrtps_cpp::_FaceDector_Response__handle;
}
...
static service_type_support_callbacks_t _FaceDector__callbacks = {
  "chat4_interfaces::srv",
  "FaceDector",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, chat4_interfaces, srv, FaceDector_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, chat4_interfaces, srv, FaceDector_Response)(),
...
static rosidl_service_type_support_t _FaceDector__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_FaceDector__callbacks,
...
{
  return &chat4_interfaces::srv::typesupport_fastrtps_cpp::_FaceDector__handle;
}
