...
#include "chat4_interfaces/srv/detail/face_detector__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const chat4_interfaces::srv::FaceDetector_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  chat4_interfaces::srv::FaceDetector_Request & ros_message)
{
  // Member: image
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = chat4_interfaces::srv::FaceDetector_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const chat4_interfaces::srv::FaceDetector_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<chat4_interfaces::srv::FaceDetector_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_chat4_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<chat4_interfaces::srv::FaceDetector_Request>()
{
  return &chat4_interfaces::srv::typesupport_fastrtps_cpp::_FaceDetector_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, chat4_interfaces, srv, FaceDetector_Request)() {
  return &chat4_interfaces::srv::typesupport_fastrtps_cpp::_FaceDetector_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_chat4_interfaces
cdr_serialize(
  const chat4_interfaces::srv::FaceDetector_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: number
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  chat4_interfaces::srv::FaceDetector_Response & ros_message)
{
  // Member: number
  cdr >> ros_message.number;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = chat4_interfaces::srv::FaceDetector_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const chat4_interfaces::srv::FaceDetector_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<chat4_interfaces::srv::FaceDetector_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &chat4_interfaces::srv::typesupport_fastrtps_cpp::_FaceDetector_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, chat4_interfaces, srv, FaceDetector_Response)() {
  return &chat4_interfaces::srv::typesupport_fastrtps_cpp::_FaceDetector_Response__handle;
}
...
{
  return &chat4_interfaces::srv::typesupport_fastrtps_cpp::_FaceDetector__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, chat4_interfaces, srv, FaceDetector)() {
  return &chat4_interfaces::srv::typesupport_fastrtps_cpp::_FaceDetector__handle;
}
