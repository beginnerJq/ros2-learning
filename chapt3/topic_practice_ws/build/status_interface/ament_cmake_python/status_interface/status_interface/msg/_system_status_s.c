...
bool status_interface__msg__system_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // memory_avilable
    PyObject * field = PyObject_GetAttrString(_pymsg, "memory_avilable");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->memory_avilable = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // net_sent
...
PyObject * status_interface__msg__system_status__convert_to_py(void * raw_ros_message)
{
  ...
  {  // memory_avilable
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->memory_avilable);
    {
      int rc = PyObject_SetAttrString(_pymessage, "memory_avilable", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
